        ...
        <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg headroom py-lg-3 px-lg-6 navbar-dark navbar-theme-primary">
            <div class="container">
                    ...
                    <div class="navbar-collapse-header">
                        <div class="row">
                            <div class="col-6 collapse-brand">
                                <a href="./index.html">
                                    <img src="./front/assets/img/brand/dark.svg" height="35" alt="Logo Impact">
                                </a>
                            </div>
                ...
                <div class="d-none d-lg-block d-lg-none">
                    <a href="{{ route('alloom_customer.login') }}" class="btn btn-secondary btn-pricing-plan animate-up-2 mr-3"><i class="fas fa-user mr-2"></i> Entrar</a>
                    <a href="../../../themesberg.com/docs/rocket/getting-started/overview/index.html" target="_blank" class="btn btn-outline-white btn-docs animate-up-2"><i class="fas fa-envelope-open mr-2"></i> Suporte</a>
                </div>
