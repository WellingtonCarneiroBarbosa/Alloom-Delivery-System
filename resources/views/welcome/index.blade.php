    ...
    <div class="row infographics-2">
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="ct-infographic-item">
          ...
          <p>Receba e gerêncie pedidos com facilidade.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="ct-infographic-item">
          ...
          <p>Pensado em você, o sistema é focado na experiência do usuário.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="ct-infographic-item">
          ...
          <p>O sistema possui um controle de caixa eficaz.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="ct-infographic-item">
          ...
          <h4>Acessível</h4>
          <p>Um sistema completo e eficiente por um preço baixo.</p>
        </div>
      </div>
    </div>
