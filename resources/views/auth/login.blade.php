...
<div class="card-body login-card-body mt-2">
    ...
    <form action="{{ url("$url/login") }}" class="form-loader" method="post">
      ...
      <div class="input-group mb-3">
        <input type="email" id="email" name="email" class="form-control" placeholder="E-mail" value="{{ old('email') }}" required>
    ...
    <p class="mb-1">
      <a href="{{ asset('admin-lte/pages/examples/forgot-password.html') }}"> {{ __('Forgot Your Password?') }}</a>
    </p>
  </div>
@endsection
{{--
